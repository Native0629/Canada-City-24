...
export default class Category9Screen extends React.Component {
    constructor(props) {
        super(props);
        this.state = { 
            offerData: [],
    ...
    getData = async () =>{
        api.getOffers(global.country_id, global.city_id, 9, this.state.page).then((res)=>{
    ...
    _onRefresh(){
        ...
        api.getOffers(global.country_id, global.city_id, 9, 1).then((res)=>{
            console.log('offer_response____', res);
            if(res.status == "200"){
