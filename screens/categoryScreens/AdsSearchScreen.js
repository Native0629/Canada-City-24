...
export default class AdsSearchScreen extends React.Component {
    constructor(props) {
        super(props);
    ...
    getData = async () => {
        var url = getSubcatesUrl + "&per_page=" + 30 + "&current_page=" + this.state.page + "&ads_location=" + global.ads_location;
        ...
        fetch(url, {
            ...
            .then((res) => {
                ...
                console.log('Ads_Location_Data_response____', res);
                if (res.status == "200") {
                    this.setState({ adsLocationData: res.ads });
    ...
    _onRefresh() {
        ...
        fetch(url, {
            ...
            .then((res) => {
                console.log('adsLocationData_response____', res);
                ...
                if (res.status == "200") {
                    ...
                    console.log("get adsLocationData data failed")
                    this.setState({ status: 0 })
                }
            })
            .catch((error) => {
            ...
            <View style={styles.container}>
                ...
                <ImageBackground source={require('../../assets/images/header.png')} style={Style.header}>
                    ...
                    <View style={{ height: 50, flexDirection: 'row', alignItems: 'center', justifyContent: 'flex-start', paddingHorizontal: 10, borderWidth: 1, borderColor: '#fff' }}>
                        <Text style={{ color: '#8b999f', fontSize: 27, fontFamily: 'cairo-semibold' }}>{global.en_lan? 'Ads Search' : 'البحث عن الإعلانات'} </Text>
                    </View>
                        ...
                        this.state.status ?
                            <ImageBackground source={require('../../assets/images/BackgroundImage.png')} style={{ width: '100%', height: '100%', marginTop: 10 }}>
                                ...
                                <FlatList
                                    ...
                                    data={this.state.adsLocationData}
